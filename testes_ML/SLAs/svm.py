...
print("Precisao (Linear): " + str(svclassifier_linear.score(X_test, y_test)))
print("Precisao (Linear): " + str(metrics.accuracy_score(y_test, y_pred_linear)))
print("----------------------------")

print("Precisao (gaussian): " + str(svclassifier_gaussian.score(X_test, y_test)))
print("Precisao (gaussian): " + str(metrics.accuracy_score(y_test, y_pred_gaussian)))
print("----------------------------")

print("Precisao (sigmoid): " + str(svclassifier_sigmoid.score(X_test, y_test)))
print("Precisao (sigmoid): " + str(metrics.accuracy_score(y_test, y_pred_sigmoid)))
print("----------------------------")

print("Precisao (poly): " + str(svclassifier_poly.score(X_test, y_test)))
